...
Firstly, I made a graph which explored the relationship between time
...
Estimations from this output: - Intercept Estimate = $N_{0}$ =
...
The full code used for this question can be found in my
